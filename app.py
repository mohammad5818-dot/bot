        ...
        if client:
            try:
                ...
                try:
                    ...
                    # ⭐⭐ خطای آپلود اختصاصی (خط ۳۲۵ در اینجا قرار دارد)
...
# =========================================================
# بخش ۶: تابع اصلی و اجرای وب‌هوک (نسخه نهایی برای Render)
# =========================================================
def main():
    ...
    print(f"✅ ربات با وب‌هوک روی URL زیر اجرا شد و باید آنلاین بماند: {full_url}")
